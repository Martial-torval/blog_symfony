...
#[Route('post/show', name: 'show', methods:'GET')]
public function show(EntityManagerInterface $manager, Post $post) {
return $this->render('post/detailPost.html.twig',['id' => $post->getId()]);
}
}
